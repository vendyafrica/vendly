...
type NotificationType = 'ORDER_PLACED' | 'DELIVERY_OUT' | 'PAYMENT_RECEIVED' | 'ORDER_DELIVERED' | 'STOCK_LOW'
...
const notifications: Notification[] = [
  {
    ...
    type: "ORDER_PLACED",
    title: "New Order",
    message: "Order #VM-9012 received from James Wilson.",
    time: "2m ago",
    isRead: false,
    data: { orderId: "VM-9012", amount: "$240.00", customerName: "James Wilson" }
  },
  {
    id: "2",
    type: "DELIVERY_OUT",
    title: "Out for Delivery",
    message: "David Chen is delivering order #VM-8945.",
    time: "45m ago",
    isRead: false,
    data: { orderId: "VM-8945", riderName: "David Chen" }
  },
  {
    id: "3",
    type: "PAYMENT_RECEIVED",
    title: "Payment Confirmed",
    message: "$156.40 received via M-Pesa for #VM-8890.",
    time: "1h ago",
    isRead: true,
    data: { orderId: "VM-8890", amount: "$156.40", method: "M-Pesa" }
  },
  {
    id: "4",
    type: "ORDER_DELIVERED",
    title: "Order Delivered",
    message: "Order #VM-8721 successfully delivered.",
    time: "3h ago",
    isRead: true,
    data: { orderId: "VM-8721" }
  },
  {
    id: "5",
    type: "STOCK_LOW",
    title: "Low Stock",
    message: "Leather Jacket inventory is low (2 left).",
    time: "5h ago",
    isRead: true
  }
]
