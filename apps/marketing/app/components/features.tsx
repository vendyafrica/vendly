...
import { InstagramIcon, WhatsappIcon, TiktokIcon, Shield01Icon } from '@hugeicons/core-free-icons'
        ...
        <div className="@xl:grid-cols-2 mt-12 grid gap-3 *:p-6">
          <Card
            ...
            <div
              ...
              <div className="pl-17 relative flex h-10 items-center justify-between gap-12 pr-6">
                ...
                <div className="bg-card shadow-black/6.5 ring-border relative flex h-8 items-center rounded-full px-3 shadow-sm ring">
                  <HugeiconsIcon icon={TiktokIcon} className="size-3.5" />
                </div>
                <div className="bg-card shadow-black/6.5 ring-border relative flex h-8 items-center rounded-full px-3 shadow-sm ring">
                  <HugeiconsIcon icon={WhatsappIcon} className="size-3.5" />
                </div>
          ...
          <Card
            ...
            <div className="pointer-events-none relative -ml-7 flex size-44 items-center justify-center pt-5">
              <HugeiconsIcon icon={Shield01Icon} className="absolute inset-0 top-2.5 size-full stroke-[0.1px] opacity-15" />
              <HugeiconsIcon icon={Shield01Icon} className="size-32 stroke-[0.1px]" />
            </div>
          </Card>
        </div>
      </div>
