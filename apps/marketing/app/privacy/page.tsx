...
export const metadata: Metadata = {
  ...
  description: "How Vendly Africa collects, uses, and protects your personal data.",
    ...
    <main className="mx-auto max-w-3xl px-6 py-12 space-y-8">
      <section className="space-y-4">
        ...
        <p>
          ...
          helps businesses and creators run storefronts and manage orders. This Privacy Policy explains what we collect, why we collect it, and how you can
