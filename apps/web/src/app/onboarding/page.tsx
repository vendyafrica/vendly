                    ...
                    <div className="space-y-5 w-full">
                        <div className="flex items-start gap-2">
                            <div className="p-3 rounded-xl shrink-0">
                                <HugeiconsIcon icon={Store01FreeIcons} className="h-4 w-4 text-primary" />
                            </div>
                            <div>
                                ...
                                <p className="text-sm text-muted-foreground leading-relaxed">
                                    Customisable storefront to sell your products online.
                                </p>
                            </div>
                        </div>
                        <div className="flex items-start gap-2">
                            <div className="p-3 rounded-xl shrink-0">
                                <HugeiconsIcon icon={Payment01FreeIcons} className="h-4 w-4 text-primary" />
                            </div>
                            <div>
                                <h3 className="text-md font-semibold mb-2">
                                    Checkout & Delivery
                        ...
                        <div className="flex items-start gap-2">
                            <div className="p-3 rounded-xl shrink-0">
                                <HugeiconsIcon icon={Analytics01FreeIcons} className="h-4 w-4 text-primary" />
                            </div>
                            <div>
                                <h3 className="text-md font-semibold mb-2">
                ...
                <form className="p-6 md:p-8">
                    <FieldGroup>
                        ...
                        <Field>
                            ...
                            <Input id="password" type="password" required className="focus-visible:border-primary/50 focus-visible:ring-primary/10" />
                        </Field>
