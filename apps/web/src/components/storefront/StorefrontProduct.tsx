...
export function StorefrontProduct({ storeSlug, productId }: StorefrontProductProps) {
    const { store, isLoading, error } = useStorefrontStore(storeSlug);
            ...
            <div className="min-h-screen bg-white flex items-center justify-center">
                <div className="text-center">
                    ...
                    <p className="mt-2 text-sm text-gray-500">
                        {error?.message || "We couldn't load this store."}
                    </p>
                </div>
            </div>
        );
