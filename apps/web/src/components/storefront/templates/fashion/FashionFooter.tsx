...
export function FashionFooter({
    ...
    const socialItems = [
        ...
        { key: "whatsapp", icon: WhatsAppIcon, href: socialLinks.whatsapp },
        { key: "twitter", icon: XIcon, href: socialLinks.twitter },
                ...
                <div className="flex flex-col items-center gap-8">
                    ...
                    {socialItems.length > 0 && (
                        <div className="flex items-center gap-6">
                            {socialItems.map(({ key, icon: Icon, href }) => (
                                <a
                                    key={key}
                                    href={href}
                                    target="_blank"
                    ...
                    {/* Divider */}
                    <div className="w-full max-w-xs h-px bg-current opacity-20" />
