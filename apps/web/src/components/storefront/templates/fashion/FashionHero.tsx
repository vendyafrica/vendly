            ...
            <div className="relative container mx-auto px-4 lg:px-8">
                <div className="max-w-lg">
                    ...
                    {label && (
                        <span
                            data-editable="label"
                            className="inline-block text-xs font-semibold tracking-[0.2em] uppercase mb-4 text-white/80"
                        >
                            {label}
                        </span>
                    )}
                    ...
                    <h1
                        data-editable="title"
                        className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-8 text-white font-serif"
                    >
                        {title}
                    </h1>
