...
import sendEmail, { sendMagicLinkEmail, sendWelcomeEmail, sendAdminVerificationEmail } from './email';

export { VerificationEmail, MagicLinkEmail, sendEmail, sendMagicLinkEmail, sendWelcomeEmail, sendAdminVerificationEmail };
