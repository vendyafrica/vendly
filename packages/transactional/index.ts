...
import sendEmail, { sendMagicLinkEmail, sendWelcomeEmail, sendAdminVerificationEmail, sendSuperAdminInviteEmail } from './email';

export { VerificationEmail, MagicLinkEmail, sendEmail, sendMagicLinkEmail, sendWelcomeEmail, sendAdminVerificationEmail, sendSuperAdminInviteEmail };
